...
This software allows to use the package CLASS from the software GILDAS, by IRAM, in an automated way. You can check the user guide and the example files (folder `example`) to learn how to use it.
